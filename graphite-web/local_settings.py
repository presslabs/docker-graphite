...
if os.getenv("POD_IP"):
    ALLOWED_HOSTS.append(os.getenv("POD_IP"))  # make kubernetes probes happy
...
AUTH_SERVER = env.str('OIDC_PROVIDER', '')
AUTH_CLIENT_ID = env.str('OIDC_CLIENT_ID', '')
AUTH_CLIENT_SECRET = env.str('OIDC_CLIENT_SECRET', '')
...
DATABASES = {
    ...
    'default': env.db('DATABASE_URL', default='sqlite:////opt/graphite/storage/graphite.db')
}
...
INSTALLED_APPS = INSTALLED_APPS + ('django_auth_oidc',)
